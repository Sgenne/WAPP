...
const LoggedInButtonsThread = (props: { userId: number | undefined, thread: Thread }): JSX.Element => {
    ...
    return (
        <><button className="button" onClick={deleteThread}>Delete thread</button><button className="button" onClick={editThread}>Edit thread</button></>
        );
  };
